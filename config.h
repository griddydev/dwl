...
static const Key keys[] = {
	...
	{ WLR_MODIFIER_ALT,                              XKB_KEY_j,          movestack,        {.i = +1} },
	{ WLR_MODIFIER_ALT,                              XKB_KEY_k,          movestack,        {.i = -1} },
	{ WLR_MODIFIER_ALT,                              XKB_KEY_h,          setmfact,         {.f = -0.05f} },
	{ WLR_MODIFIER_ALT,                              XKB_KEY_l,          setmfact,         {.f = +0.05f} },
	{ WLR_MODIFIER_ALT | WLR_MODIFIER_SHIFT,         XKB_KEY_H,          setmfact,         {.f = -0.0025f} },
	{ WLR_MODIFIER_ALT | WLR_MODIFIER_SHIFT,         XKB_KEY_L,          setmfact,         {.f = +0.0025f} },
	{ WLR_MODIFIER_ALT | WLR_MODIFIER_SHIFT,         XKB_KEY_J,          setcfact,         {.f = +0.1f} },
	{ WLR_MODIFIER_ALT | WLR_MODIFIER_SHIFT,         XKB_KEY_K,          setcfact,         {.f = -0.1f} },
